...
<blockquote>
    <center>
        ...
        <br>
        by <a href="https://www.catalent.com/" title="Catalent Home Page">
            Catalent's
        </a>
...
<blockquote>
    <ul>
        <li>
            For example, open 'exploratory_data_analysis.ipynb' to work through a notebook of <em>Exploratory Data Analysis</em><br><img alt="jupyter-lab-example" src="images/jupyter-lab-example.png" title="Notebooks Folder in Jupyter Lab"/></li>
        <li>
