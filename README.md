...
> i.e. open 'exploratory_data_analysis.py' to work through an example of *Exploratory Data Analysis*
![Notebooks Folder from Jupyter Lab](images/jupyter-lab-example.png)
